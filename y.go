...
var yyAct = [...]int{
	...
	10, 7, 8, 4, 2, 1, 5, 6, 3, 9,
}
var yyPact = [...]int{

	-1000, 1, -1000, -1000, -5, -1000, -4, -1000, -1000, -1000,
	-1000,
}
var yyPgo = [...]int{
...
yydefault:
	...
	case 3:
		...
		{
			lock.Lock()
			addCmd(yyDollar[1].s, yyDollar[2].fs)
			lock.Unlock()
		}
	case 5:
	...
	case 7:
		...
		//line vis3.y:60
		{
			yyVAL.fs = append(yyDollar[1].fs, yyDollar[2].f)
		}
	case 8:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line vis3.y:67
